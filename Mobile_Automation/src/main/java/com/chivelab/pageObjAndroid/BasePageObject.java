...
public class BasePageObject {
	...
	public static void appClose(double startyFactor, double endyFactor, int waitTime){
		...
		SingletonClass.getAndroidDriver().pressKeyCode(187); //pressKeyCode(AndroidKeyCode.KEYCODE_MENU);
		...
		try {
			...
			Dimension size = SingletonClass.getAndroidDriver().manage().window().getSize();
			Log.info(size.toString());
			int starty = (int) (size.height * startyFactor);
			int endy = (int) (size.height * endyFactor);
			int startx = size.width / 2;
			TouchAction touchAction = new TouchAction(SingletonClass.getAndroidDriver());
	...
	public void driverKeepAlive() {
		...
		try{
			orientation = SingletonClass.getAndroidDriver().getOrientation();
	...
	public void sleep(int seconds) throws InterruptedException {
		// SingletonClass.getAndroidDriver().manage().timeouts().implicitlyWait(seconds,
		// TimeUnit.SECONDS);
	...
	public void setFocus() {
		try {
			...
			SingletonClass.getAndroidDriver().pressKeyCode(187);
			sleep(2);
			SingletonClass.getAndroidDriver().pressKeyCode(187);
			sleep(3);
	...
	public boolean toggleIsEnabled(String resourceId) {
		...
		try {
			new WebDriverWait(SingletonClass.getAndroidDriver(), 5).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf((AndroidElement) SingletonClass.getAndroidDriver()
	...
	public void waitForLoading(int retryCount) throws InterruptedException {
		...
		for (int i = 0; i < retryCount; i++) {
			try {
				...
				if (((AndroidElement) SingletonClass.getAndroidDriver()
				...
				SingletonClass.getAndroidDriver().pressKeyCode(187);
				sleep(2);
				SingletonClass.getAndroidDriver().pressKeyCode(4);
				sleep(3);
			} catch(TimeoutException e){
				sleep(2);
			}
		...
		// WebDriverWait(SingletonClass.getAndroidDriver(), 30);
		// wait.until(ExpectedConditions.visibilityOf((AndroidElement)
		// SingletonClass.getAndroidDriver().findElement(
	...
	public void waitForElementById(String id, int retryCount) throws InterruptedException {
		for (int i = 0; i < retryCount; i++) {
			try {
				...
				if (((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]"))).isDisplayed()) {
	...
	public void waitForElement(MobileElement element, int seconds) {
		...
		WebDriverWait wait = new WebDriverWait(SingletonClass.getAndroidDriver(), seconds);
	...
	public void uiSendKeysById(String id, String value, boolean takeScreenshot) throws Exception {
		...
		uiSendKeys((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]")), value);
		hideKeyboard();
	...
	public void uiSendKeysByText(String text, String value) throws Exception {
		...
		uiSendKeys((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@text=\"" + text + "\"]")), value);
		hideKeyboard();
	}
	...
	public void uiSendKeysByXpath(String xpath, String value) throws Exception {
		...
		uiSendKeys((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath(xpath)), value);
		hideKeyboard();
	}
		...
		if (value == false) {
			for (int i = 0; i < scrollCount + 1; i++) {
				try {
					new WebDriverWait(SingletonClass.getAndroidDriver(), 5).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf((AndroidElement) SingletonClass.getAndroidDriver()
							.findElement(By.xpath("//*[@resource-id=\""+id+"\"]"))));
					element = (AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]"));
...
//				element = (AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]"));
	...
	public String uiGetTextById(String id, boolean takeScreenshot) throws Exception {
		...
		return uiGetText((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]")));
	}
	...
	public String uiGetTextByXpath(String xpath) throws InterruptedException {
		...
		return uiGetText((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath(xpath)));
	}
	...
	public void uiClearById(String id) throws InterruptedException {
		waitForLoading(10);
		waitForElementById(id, 10);
		uiClear((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]")));
		waitForLoading(10);
	}
	...
	public void uiClickById(String id) throws InterruptedException {
		waitForLoading(10);
		waitForElementById(id, 10);
		uiClick((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]")));
		waitForLoading(10);
	}
	...
	public void uiSendKeys(MobileElement element, String value) {
		...
		String splitLocator[];
		try {
			element = (MobileElement) (new WebDriverWait(SingletonClass.getAndroidDriver(), 20))
	...
	public void sendKeysSp(String id,String value) throws Exception {
		waitForElementById(id, 10);
		//uiSendKeys((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]")), value);
		uiSendKeys((AndroidElement) SingletonClass.getAndroidDriver().findElement(By.id(id)), value);
		hideKeyboard();
	...
	public Dimension getWindowSize() throws Exception {
		Dimension dimension = SingletonClass.getAndroidDriver().manage().window().getSize();
		return dimension;
	...
	public void swipeUpOrDown(double startyFactor, double endyFactor, int waitTime) {
		...
		try {
			...
			int endy = (int) (size.height * endyFactor);
			int startx = size.width / 2;
//			SingletonClass.getAndroidDriver().swipe(startx, starty, startx, endy, waitTime);
			TouchAction touchAction = new TouchAction(SingletonClass.getAndroidDriver());
			touchAction.press(PointOption.point(startx, starty)).waitAction(WaitOptions.waitOptions(Duration.ofMillis(waitTime))).moveTo(PointOption.point(startx, endy)).release().perform();
	...
	public void swipeVerticalElementTillFound(AndroidElement baseElement, AndroidElement targetElement, int scrollCount,
		...
		int hight = SingletonClass.getAndroidDriver().manage().window().getSize().getHeight();
	...
	public void swipeVerticalFromElement(AndroidElement baseElement, double startyFactor, double endyFactor,
			int swipeTime) {
		Dimension size;
		size = SingletonClass.getAndroidDriver().manage().window().getSize();
		int starty = (int) (size.height * startyFactor);
		int endy = (int) (size.height * endyFactor);
		Point s = baseElement.getLocation();
		int startx = s.getX();
//		SingletonClass.getAndroidDriver().swipe(startx, starty, startx, endy, swipeTime);
		TouchAction touchAction = new TouchAction(SingletonClass.getAndroidDriver());
...
//            int endY=Ycoordinate;
            ...
            new TouchAction(SingletonClass.getAndroidDriver()).longPress(PointOption.point(startX, startY)).moveTo(PointOption.point(endX, endY)).release().perform();
            break;
...
public void swipingVertical(double startyFactor, double endyFactor) throws InterruptedException {
	 ...
	 Dimension size;
      ...
      new TouchAction(SingletonClass.getAndroidDriver()).longPress(PointOption.point(startx, starty)).moveTo(PointOption.point(startx, endy)).release().perform();

//	  SingletonClass.getAndroidDriver().swipe(startx, starty, startx, endy, 3000);
	  Thread.sleep(2000);
	...
	public void hideKeyboard() throws Exception {
		...
		try {
			SingletonClass.getAndroidDriver().hideKeyboard();
	...
	public void pressEnterSoftKeyboard() throws Exception {
		...
		try {
			SingletonClass.getAndroidDriver().pressKeyCode(66);
			sleep(2);
	...
	public void waitUntilElementPresent(MobileElement element, int retryCount) throws InterruptedException {
		...
		for (int i = 0; i < retryCount; i++) {
			...
			try {
				new WebDriverWait(SingletonClass.getAndroidDriver(), 5).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf(element));
	...
	public void resetApp() throws Exception {
		...
		// clear app data
		SingletonClass.getAndroidDriver().resetApp();
	...
	public void clearBrowserData() throws Exception {
		...
		sleep(5);
		AndroidElement element = (AndroidElement)SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\"com.android.chrome:id/menu_button\"]"));
	...
	public boolean isVisibleAndroidElementByIdWithoutLog(String id) throws InterruptedException {
		...
		try {
			new WebDriverWait(SingletonClass.getAndroidDriver(), 5).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf((AndroidElement) SingletonClass.getAndroidDriver()
					.findElement(By.xpath("//*[@resource-id=\""+id+"\"]"))));
			value = SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]")).isDisplayed();
	...
	public boolean isVisibleAndroidElementByTextWithoutLog(String text) throws InterruptedException {
		...
		try {
			new WebDriverWait(SingletonClass.getAndroidDriver(), 5).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf((AndroidElement) SingletonClass.getAndroidDriver()
					.findElement(By.xpath("//*[@text=\"" + text + "\"]"))));
			value = SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@text=\"" + text + "\"]"))
					.isDisplayed();
	...
	public void verifyIsVisibleAndroidElementById(String id, String elementName, ObjectTypes objtype,
		...
		boolean value = false;
		try {
			new WebDriverWait(SingletonClass.getAndroidDriver(),15).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf((AndroidElement) SingletonClass.getAndroidDriver()
					.findElement(By.xpath("//*[@resource-id=\""+id+"\"]"))));
			value = SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@resource-id=\""+id+"\"]")).isDisplayed();
	...
	public void verifyIsVisibleAndroidElementByXpath(String xpathValue, String elementName, ObjectTypes objtype) throws Exception {
		...
		try {
			...
			value = SingletonClass.getAndroidDriver().findElement(By.xpath("//android.widget.TextView[@text=\""+xpathValue+"\"]/preceding-sibling::android.widget.ImageView")).isDisplayed();
	...
	public void verifyIsVisibleAndroidElementByText(String text, ObjectTypes objtype, boolean takeScreenshot)
		...
		boolean value = false;
		try {
			new WebDriverWait(SingletonClass.getAndroidDriver(), 10).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf((AndroidElement) SingletonClass.getAndroidDriver()
					.findElement(By.xpath("//*[@text=\"" + text + "\"]"))));
			value = SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@text=\"" + text + "\"]"))
					.isDisplayed();
	...
	public void verifyIsVisibleAndroidElementByTextContains(String text, ObjectTypes objtype, boolean takeScreenshot)
		...
		try {
			...
			value = SingletonClass.getAndroidDriver().findElement(By.xpath("//*[contains(@text,\"" + text + "\")]"))
					.isDisplayed();
	...
	public void clickAndroidElement(MobileElement element, String elementName, ObjectTypes objtype,
		...
		try {
			// element =
			// (AndroidElement)SingletonClass.getAndroidDriver().findElement(By.xpath("//android.widget.TextView[@text=\""+text+"\"]"));
			new WebDriverWait(SingletonClass.getAndroidDriver(), 5).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf(element));
			value = element.isDisplayed();
	...
	public void longPressAndroidElementByText(String txt, String elementName, ObjectTypes objtype) throws Exception {
		...
		try {
			...
			element = (AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[@text=\"" + txt + "\"]"));
			value = element.isDisplayed();
...
//		TouchActions action = new TouchActions(SingletonClass.getAndroidDriver());
//		action.longPress(element);
//		action.perform();
//		action.longPress(element).release().perform();
		
		TouchAction action = new TouchAction(SingletonClass.getAndroidDriver()).longPress(longPressOptions().withElement(element(element)).withDuration(Duration.ofMillis(3000))).release().perform();
//        Thread.sleep(5000);
		sleep(10);
//		WebElement webElement = SingletonClass.getAndroidDriver().findElement(By.xpath(element));
...
//		uiClick(element);
	...
	public void clickAndroidElementByContainsId(String id, String elementName, ObjectTypes objtype) throws Exception {
		...
		try {
			...
			element = (AndroidElement) SingletonClass.getAndroidDriver().findElement(By.xpath("//*[contains(@resource-id,\""+id+"\")]"));
			value = element.isDisplayed();
...
//			new WebDriverWait(SingletonClass.getAndroidDriver(), 5).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf((AndroidElement) SingletonClass.getAndroidDriver()
//					.findElement(By.xpath("//*[@text=\"" + text + "\"]"))));
//			element = (AndroidElement) SingletonClass.getAndroidDriver()
//					.findElement(By.xpath("//*[@text=\"" + text + "\"]"));
//			value = element.isDisplayed();
	...
	public void clickAndroidElementByText(String text, ObjectTypes objtype) throws Exception {
		...
		try {
			new WebDriverWait(SingletonClass.getAndroidDriver(), 30).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf((AndroidElement) SingletonClass.getAndroidDriver()
					.findElement(By.xpath("//*[@text=\"" + text + "\"]"))));
			element = (AndroidElement) SingletonClass.getAndroidDriver()
					.findElement(By.xpath("//*[@text=\"" + text + "\"]"));
			value = element.isDisplayed();
	...
	public void clickAndroidElementOnPage(MobileElement element, String elementName, ObjectTypes objtype,
		...
		if (value == false) {
			for (int i = 0; i < scrollCount + 1; i++) {
				try {
					// element =
					// (AndroidElement)SingletonClass.getAndroidDriver().findElement(By.xpath("//android.widget.TextView[@text=\""
					// + text + "\"]"));
					new WebDriverWait(SingletonClass.getAndroidDriver(), 5).ignoring(TimeoutException.class).ignoring(WebDriverException.class).until(ExpectedConditions.visibilityOf(element));
					value = element.isDisplayed();
	...
	public void clickPoint(int x,int y) {
		TouchAction action= new TouchAction(SingletonClass.getAndroidDriver());
