package com.chivelab.testScripts.IOS;
...
public class RegistrationLoginTest extends com.chivelab.pageObjIOS.BasePageObject{
	...
	public void setUpEnv() throws MalformedURLException {
		SingletonClass.setIOSDriver("device_1");
